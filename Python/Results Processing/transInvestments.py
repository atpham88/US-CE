...
def transInvestments(results_dir_temp, techCase, planningScr, interConn):
    if interConn == 'EI':
        finalCap = '-724'
    ...
    if planningScr == 'NE2020':
        ...
        results_dir2 = results_dir_temp + interConn + '\\' + techCase + '\\' + 'Results_' + interConn + '_Negative' + finalCap + '_DACS2020NEin2050_' + techCase.lower() + '_TrueREFERENCE\\2050CO2Cap' + finalCap + '\\CE\\'
        ...
        results_dir2 = results_dir_temp + interConn + '\\' + techCase + '\\' + 'Results_' + interConn + '_Negative' + finalCap + '_DACS2051NEin2050_' + techCase.lower() + '_TrueREFERENCE\\2050CO2Cap' + finalCap + '\\CE\\'
