...
from capacityInvestments import *
from costs import *
from generationDispatch import *
from transInvestments import *
from flows import *
from capacityInvestmentsRegions import *
...
def main():
    ...
    (CoalCCS_NE2020_ref_EI, CCCCS_NE2020_ref_EI, CC_NE2020_ref_EI, Nuclear_NE2020_ref_EI, Hydrogen_NE2020_ref_EI,Battery_NE2020_ref_EI,
     ...
     Wind_NE2020_2_ref_EI, Solar_NE2020_2_ref_EI) = capInvestments(ref_dir, techCase, planningScr='NE2020', interConn = 'EI')
    (CoalCCS_NE2050_ref_EI, CCCCS_NE2050_ref_EI, CC_NE2050_ref_EI, Nuclear_NE2050_ref_EI, Hydrogen_NE2050_ref_EI,Battery_NE2050_ref_EI,
     ...
     Solar_NE2050_2_ref_EI) = capInvestments(ref_dir, techCase, planningScr='NE2050', interConn = 'EI')
    ...
    (CoalCCS_NE2020_ref_ERCOT, CCCCS_NE2020_ref_ERCOT, CC_NE2020_ref_ERCOT, Nuclear_NE2020_ref_ERCOT, Hydrogen_NE2020_ref_ERCOT,Battery_NE2020_ref_ERCOT,
     ...
     Wind_NE2020_2_ref_ERCOT, Solar_NE2020_2_ref_ERCOT) = capInvestments(ref_dir, techCase, planningScr='NE2020', interConn = 'ERCOT')
    (CoalCCS_NE2050_ref_ERCOT, CCCCS_NE2050_ref_ERCOT, CC_NE2050_ref_ERCOT, Nuclear_NE2050_ref_ERCOT, Hydrogen_NE2050_ref_ERCOT,Battery_NE2050_ref_ERCOT,
     ...
     Wind_NE2050_2_ref_ERCOT, Solar_NE2050_2_ref_ERCOT) = capInvestments(ref_dir, techCase, planningScr='NE2050', interConn = 'ERCOT')
    ...
    df_capEXP_ref['PlanningScr'] = df_capEXP_ref['PlanningScr'].apply(wrap, args=[10])
    order = ['DACS', 'Battery', 'Hydrogen', 'NGCC', 'NGCC CCS', 'Nuclear', 'Solar PV', 'Wind']

    chart = alt.Chart(df_capEXP_ref).mark_bar(size=50).encode(
        # tell Altair which field to group columns on
        x=alt.X('PlanningScr:N', axis=alt.Axis(labelAngle=-0),title=None, sort=None),
    ...
    (miso_serc_ref_NE2020_EI, pjm_serc_ref_NE2020_EI, ne_ny_ref_NE2020_EI,
     pjm_ny_ref_NE2020_EI, pjm_miso_ref_NE2020_EI, spp_miso_ref_NE2020_EI, ercot_tot_ref_NE2020_EI) = transInvestments(ref_dir, techCase, planningScr='NE2020', interConn = 'EI')
    (miso_serc_ref_NE2050_EI, pjm_serc_ref_NE2050_EI, ne_ny_ref_NE2050_EI,
     pjm_ny_ref_NE2050_EI, pjm_miso_ref_NE2050_EI, spp_miso_ref_NE2050_EI, ercot_tot_ref_NE2050_EI) = transInvestments(ref_dir, techCase, planningScr='NE2050', interConn='EI')

    (miso_serc_ref_NE2020_ERCOT, pjm_serc_ref_NE2020_ERCOT, ne_ny_ref_NE2020_ERCOT,
     pjm_ny_ref_NE2020_ERCOT, pjm_miso_ref_NE2020_ERCOT, spp_miso_ref_NE2020_ERCOT, ercot_tot_ref_NE2020_ERCOT) = transInvestments(ref_dir, techCase, planningScr='NE2020', interConn='ERCOT')
    (miso_serc_ref_NE2050_ERCOT, pjm_serc_ref_NE2050_ERCOT, ne_ny_ref_NE2050_ERCOT,
     pjm_ny_ref_NE2050_ERCOT, pjm_miso_ref_NE2050_ERCOT, spp_miso_ref_NE2050_ERCOT, ercot_tot_ref_NE2050_ERCOT) = transInvestments(ref_dir, techCase, planningScr='NE2050', interConn='ERCOT')
    ...
    chart = alt.Chart(df_transEXP_ref).mark_bar(size=50).encode(
        # tell Altair which field to group columns on
        x=alt.X('PlanningScr:N', axis=alt.Axis(labelAngle=-90), title=None, sort=alt.EncodingSortField(field="PlanningScr", op="count", order='ascending')),
        # tell Altair which field to use as Y values and how to calculate
        y=alt.Y('sum(Capacity):Q',
                axis=alt.Axis(
                    grid=False,
    ...
    (netFlow_EI_serc_NE2020_EI, netFlow_EI_ny_NE2020_EI, netFlow_EI_miso_NE2020_EI,
     ...
     netFlow_ERCOT_SW_NE2020_EI, netFlow_ERCOT_NE_NE2020_EI, netFlow_ERCOT_SE_NE2020_EI) = transFlows(ref_dir, techCase, planningScr='NE2020', interConn='EI')
    (netFlow_EI_serc_NE2050_EI, netFlow_EI_ny_NE2050_EI, netFlow_EI_miso_NE2050_EI,
     ...
     netFlow_ERCOT_SW_NE2050_EI, netFlow_ERCOT_NE_NE2050_EI, netFlow_ERCOT_SE_NE2050_EI) = transFlows(ref_dir, techCase, planningScr='NE2050', interConn='EI')
    ...
    (netFlow_EI_serc_NE2020_ERCOT, netFlow_EI_ny_NE2020_ERCOT, netFlow_EI_miso_NE2020_ERCOT,
     ...
     netFlow_ERCOT_SW_NE2020_ERCOT, netFlow_ERCOT_NE_NE2020_ERCOT, netFlow_ERCOT_SE_NE2020_ERCOT) = transFlows(ref_dir, techCase, planningScr='NE2020', interConn='ERCOT')
    (netFlow_EI_serc_NE2050_ERCOT, netFlow_EI_ny_NE2050_ERCOT, netFlow_EI_miso_NE2050_ERCOT,
     ...
     netFlow_ERCOT_SW_NE2050_ERCOT, netFlow_ERCOT_NE_NE2050_ERCOT, netFlow_ERCOT_SE_NE2050_ERCOT) = transFlows(ref_dir, techCase, planningScr='NE2050', interConn='ERCOT')
    ...
    (totCost_NE2020_ref_EI, opCost_data_NE2020_ref_EI, fixedCost_data_NE2020_ref_EI,
     totCost_NE2020_ref_EI_2, opCost_data_NE2020_ref_EI_2, fixedCost_data_NE2020_ref_EI_2) = costCal(ref_dir, techCase, planningScr='NE2020', interConn = 'EI')
    (totCost_NE2050_ref_EI, opCost_data_NE2050_ref_EI, fixedCost_data_NE2050_ref_EI,
     totCost_NE2050_ref_EI_2, opCost_data_NE2050_ref_EI_2, fixedCost_data_NE2050_ref_EI_2) = costCal(ref_dir, techCase, planningScr='NE2050', interConn = 'EI')

    (totCost_NE2020_ref_ERCOT, opCost_data_NE2020_ref_ERCOT, fixedCost_data_NE2020_ref_ERCOT,
     totCost_NE2020_ref_ERCOT_2, opCost_data_NE2020_ref_ERCOT_2, fixedCost_data_NE2020_ref_ERCOT_2) = costCal(ref_dir, techCase, planningScr='NE2020', interConn='ERCOT')
    (totCost_NE2050_ref_ERCOT, opCost_data_NE2050_ref_ERCOT, fixedCost_data_NE2050_ref_ERCOT,
     totCost_NE2050_ref_ERCOT_2, opCost_data_NE2050_ref_ERCOT_2, fixedCost_data_NE2050_ref_ERCOT_2) = costCal(ref_dir, techCase, planningScr='NE2050', interConn='ERCOT')
    ...
    df_costs_ref['PlanningScr'] = df_costs_ref['PlanningScr'].apply(wrap, args=[10])
    ...
    # Generation:
    (Coal_Gen_NE2020_EI, CCCCS_Gen_NE2020_EI, CC_Gen_NE2020_EI, battery_Gen_NE2020_EI, hydrogen_Gen_NE2020_EI,
     nuclear_Gen_NE2020_EI, dac_Gen_NE2020_EI, solar_Gen_NE2020_EI, wind_Gen_NE2020_EI, CT_Gen_NE2020_EI,
     OG_Gen_NE2020_EI, bio_Gen_NE2020_EI, pump_Gen_NE2020_EI, Others_Gen_NE2020_EI) = genDispatch(ref_dir, techCase, planningScr='NE2020', interConn='EI')
    (Coal_Gen_NE2050_EI, CCCCS_Gen_NE2050_EI, CC_Gen_NE2050_EI, battery_Gen_NE2050_EI, hydrogen_Gen_NE2050_EI,
     nuclear_Gen_NE2050_EI, dac_Gen_NE2050_EI, solar_Gen_NE2050_EI, wind_Gen_NE2050_EI, CT_Gen_NE2050_EI,
     OG_Gen_NE2050_EI, bio_Gen_NE2050_EI, pump_Gen_NE2050_EI, Others_Gen_NE2050_EI) = genDispatch(ref_dir, techCase, planningScr='NE2050', interConn='EI')

    (Coal_Gen_NE2020_ERCOT, CCCCS_Gen_NE2020_ERCOT, CC_Gen_NE2020_ERCOT, battery_Gen_NE2020_ERCOT, hydrogen_Gen_NE2020_ERCOT,
     nuclear_Gen_NE2020_ERCOT, dac_Gen_NE2020_ERCOT, solar_Gen_NE2020_ERCOT, wind_Gen_NE2020_ERCOT, CT_Gen_NE2020_ERCOT,
     OG_Gen_NE2020_ERCOT, bio_Gen_NE2020_ERCOT, pump_Gen_NE2020_ERCOT, Others_Gen_NE2020_ERCOT) = genDispatch(ref_dir, techCase, planningScr='NE2020', interConn='ERCOT')
    (Coal_Gen_NE2050_ERCOT, CCCCS_Gen_NE2050_ERCOT, CC_Gen_NE2050_ERCOT, battery_Gen_NE2050_ERCOT, hydrogen_Gen_NE2050_ERCOT,
     nuclear_Gen_NE2050_ERCOT, dac_Gen_NE2050_ERCOT, solar_Gen_NE2050_ERCOT, wind_Gen_NE2050_ERCOT, CT_Gen_NE2050_ERCOT,
     OG_Gen_NE2050_ERCOT, bio_Gen_NE2050_ERCOT, pump_Gen_NE2050_ERCOT, Others_Gen_NE2050_ERCOT) = genDispatch(ref_dir, techCase, planningScr='NE2050', interConn='ERCOT')

    df_Gen_ref = graphGen(Coal_Gen_NE2020_EI, CCCCS_Gen_NE2020_EI, CC_Gen_NE2020_EI, battery_Gen_NE2020_EI, hydrogen_Gen_NE2020_EI,
                          nuclear_Gen_NE2020_EI, dac_Gen_NE2020_EI, solar_Gen_NE2020_EI, wind_Gen_NE2020_EI, CT_Gen_NE2020_EI,
    ...
    df_Gen_ref['PlanningScr'] = df_Gen_ref['PlanningScr'].apply(wrap, args=[10])
    chart = alt.Chart(df_Gen_ref).mark_bar(size=50).encode(
        # tell Altair which field to group columns on
        x=alt.X('PlanningScr:N', axis=alt.Axis(labelAngle=-0), title=None, sort=alt.EncodingSortField(field="PlanningScr", op="count", order='ascending')),
        # tell Altair which field to use as Y values and how to calculate
        y=alt.Y('sum(Gen):Q',
                axis=alt.Axis(
                    grid=False,
                    title='Generation or Consumption (TWh)')),
        # tell Altair which field to use to use as the set of columns to be  represented in each group
        column=alt.Column('Region:N', title=None, header=alt.Header(labelFontSize=20)),
        order=alt.Order(
            # Sort the segments of the bars by this field
        ...
        color=alt.Color('Technology:N',
                        scale=alt.Scale(
                            # make it look pretty with an enjoyable color pallet
                            range=['#ff6f69', '#96ceb4', 'darkolivegreen', 'black', 'saddlebrown', 'lightpink', '#ffcc5c', 'skyblue'],
                        ),
                        )).resolve_scale(y='independent').configure_view(
        # remove grid lines around column clusters
        # strokeOpacity=0
    ...
    chart = alt.Chart(df_Gen_ref).mark_bar(size=50).encode(
        # tell Altair which field to group columns on
        y=alt.X('PlanningScr:N', axis=alt.Axis(labelAngle=-0), title=None, sort=alt.EncodingSortField(field="PlanningScr", op="count", order='ascending')),
        # tell Altair which field to use as Y values and how to calculate
        x=alt.Y('sum(Gen):Q',
                axis=alt.Axis(
                    grid=False,
        ...
        color=alt.Color('Technology:N',
                        ...
                        )).resolve_scale(y='shared',x='independent').configure_view(
        # remove grid lines around column clusters
        # strokeOpacity=0
    ).configure_axis(titleFontSize=16, labelFontSize=14).configure_legend(labelFontSize=15, titleFontSize=15
                                                                          ).properties(width=400, height=120).show()


    # Generation by region:
    (CCCCS_Gen_SERC_NE2020_EI, CC_Gen_SERC_NE2020_EI, battery_Gen_SERC_NE2020_EI, hydrogen_Gen_SERC_NE2020_EI,
     ...
     wind_Gen_SE_NE2020_EI) = genDispatchRegions(ref_dir, techCase, planningScr='NE2020', interConn='EI')
    ...
    (CCCCS_Gen_SERC_NE2050_EI, CC_Gen_SERC_NE2050_EI, battery_Gen_SERC_NE2050_EI, hydrogen_Gen_SERC_NE2050_EI,
     ...
     wind_Gen_SE_NE2050_EI) = genDispatchRegions(ref_dir, techCase, planningScr='NE2050', interConn='EI')
    ...
    (CCCCS_Gen_SERC_NE2020_ERCOT, CC_Gen_SERC_NE2020_ERCOT, battery_Gen_SERC_NE2020_ERCOT, hydrogen_Gen_SERC_NE2020_ERCOT,
     ...
     wind_Gen_SE_NE2020_ERCOT) = genDispatchRegions(ref_dir, techCase, planningScr='NE2020', interConn='ERCOT')
    ...
    (CCCCS_Gen_SERC_NE2050_ERCOT, CC_Gen_SERC_NE2050_ERCOT, battery_Gen_SERC_NE2050_ERCOT, hydrogen_Gen_SERC_NE2050_ERCOT,
     ...
     wind_Gen_SE_NE2050_ERCOT) = genDispatchRegions(ref_dir, techCase, planningScr='NE2050', interConn='ERCOT')

    df_genCERegion_ref = graphGenRegions(CCCCS_Gen_SERC_NE2020_EI,CC_Gen_SERC_NE2020_EI,battery_Gen_SERC_NE2020_EI,hydrogen_Gen_SERC_NE2020_EI,
                                         nuclear_Gen_SERC_NE2020_EI,dac_Gen_SERC_NE2020_EI,solar_Gen_SERC_NE2020_EI,wind_Gen_SERC_NE2020_EI,
                                         CCCCS_Gen_NY_NE2020_EI,CC_Gen_NY_NE2020_EI,battery_Gen_NY_NE2020_EI,hydrogen_Gen_NY_NE2020_EI,
                                         nuclear_Gen_NY_NE2020_EI,dac_Gen_NY_NE2020_EI,solar_Gen_NY_NE2020_EI, wind_Gen_NY_NE2020_EI,CCCCS_Gen_NE_NE2020_EI,
                                         CC_Gen_NE_NE2020_EI,battery_Gen_NE_NE2020_EI,hydrogen_Gen_NE_NE2020_EI,nuclear_Gen_NE_NE2020_EI,
    ...
    p = alt.Chart(df_genCERegion_ref).mark_bar(size=25).encode(
        y=alt.Y('sum(Gen):Q', axis=alt.Axis(grid=False, title='Generation (TWh)')),
        ...
        color=alt.Color('Technology:N', scale=alt.Scale(range=['#ff6f69', '#96ceb4', 'darkolivegreen', 'black', 'saddlebrown', 'lightpink', '#ffcc5c', 'skyblue'], ), ),
    ...
    # Capacity factors:
    cf_CCCCS_NE2020_EI = CCCCS_Gen_NE2020_EI*1000 / (CCCCS_NE2020_ref_EI * 8760)
    cf_nuclear_NE2020_EI = nuclear_Gen_NE2020_EI * 1000 / (Nuclear_NE2020_ref_EI * 8760)
    cf_dac_NE2020_EI = dac_Gen_NE2020_EI * 1000 / (DAC_NE2020_ref_EI * 8760)
    cf_bat_NE2020_EI = battery_Gen_NE2020_EI * 1000 / (Battery_NE2020_ref_EI * 8760)
    cf_h2_NE2020_EI = hydrogen_Gen_NE2020_EI * 1000 / (Hydrogen_NE2020_ref_EI * 8760)

    cf_CCCCS_NE2050_EI = CCCCS_Gen_NE2050_EI * 1000 / (CCCCS_NE2050_ref_EI * 8760)
    cf_nuclear_NE2050_EI = nuclear_Gen_NE2050_EI * 1000 / (Nuclear_NE2050_ref_EI * 8760)
    cf_dac_NE2050_EI = dac_Gen_NE2050_EI * 1000 / (DAC_NE2050_ref_EI * 8760)
    cf_bat_NE2050_EI = battery_Gen_NE2050_EI * 1000 / (Battery_NE2050_ref_EI * 8760)
    cf_h2_NE2050_EI = hydrogen_Gen_NE2050_EI * 1000 / (Hydrogen_NE2050_ref_EI * 8760)


    cf_CCCCS_NE2020_ERCOT = CCCCS_Gen_NE2020_ERCOT * 1000 / (CCCCS_NE2020_ref_ERCOT * 8760)
    cf_nuclear_NE2020_ERCOT = nuclear_Gen_NE2020_ERCOT * 1000 / (Nuclear_NE2020_ref_ERCOT * 8760)
    cf_dac_NE2020_ERCOT = dac_Gen_NE2020_ERCOT * 1000 / (DAC_NE2020_ref_ERCOT * 8760)
    cf_bat_NE2020_ERCOT = battery_Gen_NE2020_ERCOT * 1000 / (Battery_NE2020_ref_ERCOT * 8760)
    cf_h2_NE2020_ERCOT = hydrogen_Gen_NE2020_ERCOT * 1000 / (Hydrogen_NE2020_ref_ERCOT * 8760)

    cf_CCCCS_NE2050_ERCOT = CCCCS_Gen_NE2050_ERCOT * 1000 / (CCCCS_NE2050_ref_ERCOT * 8760)
    cf_nuclear_NE2050_ERCOT = nuclear_Gen_NE2050_ERCOT * 1000 / (Nuclear_NE2050_ref_ERCOT * 8760)
    cf_dac_NE2050_ERCOT = dac_Gen_NE2050_ERCOT * 1000 / (DAC_NE2050_ref_ERCOT * 8760)
    cf_bat_NE2050_ERCOT = battery_Gen_NE2050_ERCOT * 1000 / (Battery_NE2050_ref_ERCOT * 8760)
    cf_h2_NE2050_ERCOT = hydrogen_Gen_NE2050_ERCOT * 1000 / (Hydrogen_NE2050_ref_ERCOT * 8760)

    df_CF_ref = genCF(cf_CCCCS_NE2050_EI, cf_dac_NE2050_EI, cf_bat_NE2050_EI, cf_h2_NE2050_EI,
    ...
    df_CF_EI_ref = df_CF_ref.loc[df_CF_ref['Region'] == 'EI']
    df_CF_ERCOT_ref = df_CF_ref.loc[df_CF_ref['Region'] == 'ERCOT']

    chart2 = alt.Chart(df_CF_EI_ref).mark_bar(size=50).encode(
        # tell Altair which field to group columns on
        x=alt.X('PlanningScr', title=None),
        # tell Altair which field to use as Y values and how to calculate
        y=alt.Y('Capacity Factor',
                axis=alt.Axis(
                    grid=False,
                    title='Capacity Factors')),
        # tell Altair which field to use to use as the set of columns to be  represented in each group
        column=alt.Column('Technology', title=None, header=alt.Header(labelFontSize=20)),
        # tell Altair which field to use for color segmentation
        color=alt.Color('Technology', legend=None,
                        scale=alt.Scale(range=['#ff6f69', '#96ceb4', '#ffcc5c', 'skyblue']),
                        )).configure_view(
        # remove grid lines around column clusters
        # strokeOpacity=0
    ).configure_axis(titleFontSize=16, labelFontSize=14).configure_legend(labelFontSize=15, titleFontSize=15
                                                                          ).properties(width=100, height=400).show()

    chart3 = alt.Chart(df_CF_ERCOT_ref).mark_bar(size=50).encode(
        # tell Altair which field to group columns on
        x=alt.X('PlanningScr', title=None),
        # tell Altair which field to use as Y values and how to calculate
        y=alt.Y('Capacity Factor',
    ...
    (CoalCCS_SERC_NE2020_EI, CoalCCS_NE_NE2020_EI, CoalCCS_NY_NE2020_EI, CoalCCS_MISO_NE2020_EI, CoalCCS_PJM_NE2020_EI, CoalCCS_SPP_NE2020_EI,
     ...
     Solar_NW_NE2020_EI_2, Solar_SW_NE2020_EI_2, Solar_NOE_NE2020_EI_2, Solar_SE_NE2020_EI_2) = capRegions(ref_dir, techCase, planningScr='NE2020', interConn='EI')
    ...
    (CoalCCS_SERC_NE2050_EI, CoalCCS_NE_NE2050_EI, CoalCCS_NY_NE2050_EI, CoalCCS_MISO_NE2050_EI, CoalCCS_PJM_NE2050_EI, CoalCCS_SPP_NE2050_EI,
     ...
     Solar_NW_NE2050_EI_2, Solar_SW_NE2050_EI_2, Solar_NOE_NE2050_EI_2, Solar_SE_NE2050_EI_2) = capRegions(ref_dir, techCase, planningScr='NE2050', interConn='EI')
    ...
    (CoalCCS_SERC_NE2020_ERCOT, CoalCCS_NE_NE2020_ERCOT, CoalCCS_NY_NE2020_ERCOT, CoalCCS_MISO_NE2020_ERCOT, CoalCCS_PJM_NE2020_ERCOT, CoalCCS_SPP_NE2020_ERCOT,
     ...
     Solar_NW_NE2020_ERCOT_2, Solar_SW_NE2020_ERCOT_2, Solar_NOE_NE2020_ERCOT_2, Solar_SE_NE2020_ERCOT_2) = capRegions(ref_dir, techCase, planningScr='NE2020', interConn='ERCOT')
    ...
    (CoalCCS_SERC_NE2050_ERCOT, CoalCCS_NE_NE2050_ERCOT, CoalCCS_NY_NE2050_ERCOT, CoalCCS_MISO_NE2050_ERCOT, CoalCCS_PJM_NE2050_ERCOT, CoalCCS_SPP_NE2050_ERCOT,
     ...
     Solar_NW_NE2050_ERCOT_2, Solar_SW_NE2050_ERCOT_2, Solar_NOE_NE2050_ERCOT_2, Solar_SE_NE2050_ERCOT_2) = capRegions(ref_dir, techCase, planningScr='NE2050', interConn='ERCOT')
...
def graphCE(CoalCCS_NE2020_ref_EI, CCCCS_NE2020_ref_EI, CC_NE2020_ref_EI, Nuclear_NE2020_ref_EI, Hydrogen_NE2020_ref_EI,Battery_NE2020_ref_EI,
  ...
  planning_Col = ['Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now', 'Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now']
...
def graphEICap(CoalCCS_SERC_NE2020_EI, CoalCCS_NE_NE2020_EI, CoalCCS_NY_NE2020_EI, CoalCCS_MISO_NE2020_EI, CoalCCS_PJM_NE2020_EI, CoalCCS_SPP_NE2020_EI,
    ...
    planning_Col = ['Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now', 'Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now',
                    'Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now', 'Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now',
                    'Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now', 'Plan After Net-Zero NZS', 'Plan After Net-Zero NES', 'Plan Now']
